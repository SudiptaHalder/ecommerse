...
export default function About() {
  ...
  return (
    <section
      ref={sectionRef}
      style={{ backgroundColor: "#f8f5f0" }}   // ⭐ NEW BACKGROUND COLOR
      className="min-h-[300vh] relative overflow-visible"
    >
      <div
        ref={containerRef}
        className="sticky top-0 h-screen flex items-center justify-center px-6"
      >
        <div className="max-w-6xl mx-auto w-full relative">
          ...
          <div className="relative z-10 text-center">
            ...
            <motion.div style={{ opacity: textOpacity, y: textY }}>
              <header className="mb-8">
                <p className="text-[#333] font-medium text-lg mb-4">About Us</p>
